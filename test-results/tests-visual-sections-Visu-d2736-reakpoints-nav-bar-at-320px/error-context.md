...
- Name: Visual regression for site sections at mobile breakpoints >> nav-bar at 320px
...
Error: expect(Buffer).toMatchSnapshot(expected)
  ...
  Expected an image 320px by 116px, received 320px by 64px. 1882 pixels (ratio 0.06 of all image pixels) are different.

Expected: C:\Users\atlas\buddies-html\tests\visual-sections.spec.ts-snapshots\ref-png-nav-bar-320-win32.png
Received: C:\Users\atlas\buddies-html\test-results\tests-visual-sections-Visu-d2736-reakpoints-nav-bar-at-320px\ref-png-nav-bar-320-actual.png
    Diff: C:\Users\atlas\buddies-html\test-results\tests-visual-sections-Visu-d2736-reakpoints-nav-bar-at-320px\ref-png-nav-bar-320-diff.png
