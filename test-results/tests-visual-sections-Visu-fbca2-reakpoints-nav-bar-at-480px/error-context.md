...
- Name: Visual regression for site sections at mobile breakpoints >> nav-bar at 480px
...
Error: expect(Buffer).toMatchSnapshot(expected)
  ...
  Expected an image 480px by 116px, received 480px by 64px. 2158 pixels (ratio 0.04 of all image pixels) are different.

Expected: C:\Users\atlas\buddies-html\tests\visual-sections.spec.ts-snapshots\ref-png-nav-bar-480-win32.png
Received: C:\Users\atlas\buddies-html\test-results\tests-visual-sections-Visu-fbca2-reakpoints-nav-bar-at-480px\ref-png-nav-bar-480-actual.png
    Diff: C:\Users\atlas\buddies-html\test-results\tests-visual-sections-Visu-fbca2-reakpoints-nav-bar-at-480px\ref-png-nav-bar-480-diff.png
