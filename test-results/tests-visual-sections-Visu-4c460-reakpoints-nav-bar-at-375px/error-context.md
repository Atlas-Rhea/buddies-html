...
- Name: Visual regression for site sections at mobile breakpoints >> nav-bar at 375px
...
Error: expect(Buffer).toMatchSnapshot(expected)
  ...
  Expected an image 375px by 116px, received 375px by 64px. 1975 pixels (ratio 0.05 of all image pixels) are different.

Expected: C:\Users\atlas\buddies-html\tests\visual-sections.spec.ts-snapshots\ref-png-nav-bar-375-win32.png
Received: C:\Users\atlas\buddies-html\test-results\tests-visual-sections-Visu-4c460-reakpoints-nav-bar-at-375px\ref-png-nav-bar-375-actual.png
    Diff: C:\Users\atlas\buddies-html\test-results\tests-visual-sections-Visu-4c460-reakpoints-nav-bar-at-375px\ref-png-nav-bar-375-diff.png
